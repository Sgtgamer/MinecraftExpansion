...
public class GuiCompressor extends GuiContainer
{
    ...
    private TileEntityCompressor tilesmelter;

    public GuiCompressor(InventoryPlayer par1InventoryPlayer, TileEntityCompressor par2TileEntitySmelter)
    {
        super(new ContainerCompressor(par1InventoryPlayer, par2TileEntitySmelter));
