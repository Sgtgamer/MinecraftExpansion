...
public class WorkstationShapedRecipes implements IRecipe
{
    ...
    public WorkstationShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public WorkstationShapedRecipes func_92100_c()
    {
