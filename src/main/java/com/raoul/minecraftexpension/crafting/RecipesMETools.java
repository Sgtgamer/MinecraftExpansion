...
public class RecipesMETools
{
    private String[][] recipePatterns = new String[][] {{"XXX", " # ", " # "}, {"X", "#", "#"}, {"XX", "X#", " #"}, {"XX", " #", " #"}};
    private Object[][] recipeItems;

    public RecipesMETools()
    {
     ...
     */
    public void addRecipes(WorkstationCraftingManager CraftingManager)
    {
        for (int i = 0; i < this.recipeItems[0].length; ++i)
        {
            ...
            for (int j = 0; j < this.recipeItems.length - 1; ++j)
            {
                ...
                CraftingManager.addShapedRecipe(new ItemStack(item), new Object[] {this.recipePatterns[j], '#', Items.stick, 'X', object});
            }
        }

        //CraftingManager.addShapedRecipe(new ItemStack(Items.shears), new Object[]{" #", "# ", '#', Items.iron_ingot});
    }
}
