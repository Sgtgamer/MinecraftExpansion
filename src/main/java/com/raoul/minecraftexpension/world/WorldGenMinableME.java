...
public class WorldGenMinableME extends WorldGenerator
{
    ...
    public WorldGenMinableME(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, BlocksInit.MEStone);
    }

    public WorldGenMinableME(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenMinableME(Block block, int meta, int number, Block target)
    {
