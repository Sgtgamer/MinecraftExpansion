...
import com.raoul.minecraftexpension.dimension.TeleporterME;
...
public class BlockMEPortal extends BlockBreakable
{
	public static final int[][] field_150001_a = new int[][] {new int[0], {3, 1}, {2, 0}};
    private static final String __OBFID = "CL_00000284";

	public BlockMEPortal()
	{
    ...
    {
        BlockMEPortal.SizeME SizeME = new BlockMEPortal.SizeME(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
        BlockMEPortal.SizeME size1 = new BlockMEPortal.SizeME(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);

        if (SizeME.func_150860_b() && SizeME.field_150864_e == 0)
        {
        	SizeME.func_150859_c();
            return true;
        }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        BlockMEPortal.SizeME SizeME = new BlockMEPortal.SizeME(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
        BlockMEPortal.SizeME size1 = new BlockMEPortal.SizeME(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);

        if (l == 1 && (!SizeME.func_150860_b() || SizeME.field_150864_e < SizeME.field_150868_h * SizeME.field_150862_g))
        {
        ...
        else if (l == 0 && !SizeME.func_150860_b() && !size1.func_150860_b())
        {
            p_149695_1_.setBlock(p_149695_2_, p_149695_3_, p_149695_4_, Blocks.air);
        }
    }
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
    	if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
             ...
             {
                     thePlayer.timeUntilPortal = 10;
                     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Reference.DimensionID, new TeleporterME(thePlayer.mcServer.worldServerForDimension(Reference.DimensionID)));
             }
             else
             {
                     thePlayer.timeUntilPortal = 10;
                     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterME(thePlayer.mcServer.worldServerForDimension(0)));
             }
          }
    }
    ...
    public static class SizeME
        {
            ...
            public SizeME(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
            {
                this.field_150867_a = p_i45415_1_;
                this.field_150865_b = p_i45415_5_;
                this.field_150863_d = BlockMEPortal.field_150001_a[p_i45415_5_][0];
                this.field_150866_c = BlockMEPortal.field_150001_a[p_i45415_5_][1];
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    ...
                    {
                        k = this.field_150861_f.posX + j * Direction.offsetX[BlockMEPortal.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockMEPortal.field_150001_a[this.field_150865_b][1]];
                        ...
                        if (block == BlocksInit.PortalBlock)
                        {
                            ++this.field_150864_e;
                        }
                        ...
                        if (j == 0)
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockMEPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockMEPortal.field_150001_a[this.field_150865_b][0]]);
                        ...
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockMEPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockMEPortal.field_150001_a[this.field_150865_b][1]]);
                ...
                {
                    j = this.field_150861_f.posX + i * Direction.offsetX[BlockMEPortal.field_150001_a[this.field_150865_b][1]];
                    k = this.field_150861_f.posY + this.field_150862_g;
                    l = this.field_150861_f.posZ + i * Direction.offsetZ[BlockMEPortal.field_150001_a[this.field_150865_b][1]];

                    if (this.field_150867_a.getBlock(j, k, l) != Blocks.glowstone)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == BlocksInit.PortalFire || p_150857_1_ == BlocksInit.PortalBlock;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    for (int l = 0; l < this.field_150862_g; ++l)
                    {
                        ...
                        this.field_150867_a.setBlock(j, i1, k, BlocksInit.PortalBlock, this.field_150865_b, 2);
                    }
                }
            }
        }
