...
public class BlockSmelter extends BlockContainer
{
    ...
    public BlockSmelter(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        return Item.getItemFromBlock(BlocksInit.Smelter);
    }
    ...
    */
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        {
            TileEntityMESmelter tileentity = (TileEntityMESmelter) world.getTileEntity(x, y, z);
            if (tileentity != null)
            {
                player.openGui(MinecraftExpansion.instance, GuiId.Smelter, world, x, y, z);
            }
    ...
    {
        return new TileEntityMESmelter();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase p_149689_5_, ItemStack itemstack)
    {
        ...
        {
            ((TileEntityMESmelter)world.getTileEntity(x, y, z)).func_145951_a(itemstack.getDisplayName());
        }
    }
